        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    RoomKey = table.Column<string>(type: "text", nullable: true),
                    Created = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvitedName = table.Column<string>(type: "text", nullable: false),
                    Blocked = table.Column<bool>(type: "boolean", nullable: false),
                    BlockedById = table.Column<string>(type: "text", nullable: true),
                    BlockedByName = table.Column<string>(type: "text", nullable: true),
                    Created = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FeatureUserProfile", x => new { x.FeaturesId, x.UserProfilesId });
                    table.ForeignKey(
                        name: "FK_FeatureUserProfile_Features_FeaturesId",
                        column: x => x.FeaturesId,
                        principalTable: "Features",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FeatureUserProfile_UserProfiles_UserProfilesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Keys_UserProfiles_UserProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomUserProfile", x => new { x.MembersId, x.RoomsId });
                    table.ForeignKey(
                        name: "FK_RoomUserProfile_Rooms_RoomsId",
                        column: x => x.RoomsId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoomUserProfile_UserProfiles_MembersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomUserProfile_RoomsId",
                table: "RoomUserProfile",
                column: "RoomsId");

            migrationBuilder.CreateIndex(
                name: "IX_UserConnections_InvitedId",
                table: "UserConnections",
                column: "InvitedId");

            migrationBuilder.CreateIndex(
                name: "IX_UserConnections_InviterId",
                table: "UserConnections",
                column: "InviterId");
        }
