...
namespace Sechat.Data.Migrations
{
    ...
    [Migration("20230507095000_CallLogAndFeaturesUpdate")]
    partial class CallLogAndFeaturesUpdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sechat.Data.Models.CallLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Sechat.Data.Models.Feature", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Sechat.Data.Models.Key", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Sechat.Data.Models.Message", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Sechat.Data.Models.MessageViewer", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Sechat.Data.Models.NotificationSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Sechat.Data.Models.Room", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Sechat.Data.Models.UserConnection", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Sechat.Data.Models.UserProfile", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("FeatureUserProfile", b =>
                {
                    b.HasOne("Sechat.Data.Models.Feature", null)
                        .WithMany()
                        .HasForeignKey("FeaturesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Sechat.Data.Models.UserProfile", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RoomUserProfile", b =>
                {
                    ...
                    b.HasOne("Sechat.Data.Models.Room", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Sechat.Data.Models.CallLog", b =>
                {
                    b.HasOne("Sechat.Data.Models.UserProfile", "UserProfile")
                        .WithMany("CallLogs")
            ...
            modelBuilder.Entity("Sechat.Data.Models.Message", b =>
                {
                    b.HasOne("Sechat.Data.Models.Room", "Room")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("Sechat.Data.Models.MessageViewer", b =>
                {
                    b.HasOne("Sechat.Data.Models.Message", "Message")
